#include "example_cpp_pkg/tracker.hpp"
...
{
  RCLCPP_WARN(get_logger(), "got frame!");
  ...
  std::cout << "initializing tracker node!\n";
}
...
void Tracker::_designateControl(geometry_msgs::msg::Twist &vel_msg, cv::Rect2d obj, uint32_t img_width)
{
